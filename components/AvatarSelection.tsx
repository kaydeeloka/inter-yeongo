      ...
      <div className="grid grid-cols-2 gap-4 max-w-sm mx-auto overflow-y-auto pb-4">
        {AVATARS.map((a) => (
          <button
            key={a.id}
            onClick={() => onSelect(a)}
            className="bg-white border-4 border-[#312e81] p-4 rounded-[2rem] shadow-[4px_4px_0px_0px_rgba(49,46,129,1)] hover:bg-indigo-50 hover:-translate-y-1 transition-all flex flex-col items-center gap-2 group"
          >
            <FrogMascot
