...
export const SPEAKING_CHALLENGES: SpeakingChallenge[] = [
  ...
  },
  {
    id: 'cafe-5',
    categoryId: 'cafe',
    sentence: 'My coffee betrayed me.',
    korean: '커피가 저를 배신했어요.',
    nativeTip: '유머는 “betrayed me” 톤만 살리면 과하지 않아요.',
    passFeedback: '드립이 과하지 않게 박혔어요. 공감 버튼.',
    failFeedback: '“betrayed”가 흐릿했어요. 재미 포인트만 한 번 더!',
    difficulty: 'medium',
  },
  {
    id: 'conv-1',
  ...
  },
  {
    id: 'conv-2',
    categoryId: 'convenience',
    sentence: 'Please heat this up.',
    korean: '이거 데워주세요.',
    nativeTip: '“heat this up”이 데우기 표현의 기본 조합이에요.',
    passFeedback: '편의점 직원이 바로 전자레인지 향하는 타입.',
    failFeedback: '“heat up”이 묻혔어요. 그 두 단어만 또렷하게!',
    difficulty: 'easy',
  },
  {
    id: 'conv-3',
  ...
  },
  {
    id: 'conv-4',
    categoryId: 'convenience',
    sentence: 'I opened it by mistake.',
    korean: '실수로 열었어요.',
    nativeTip: '“by mistake”가 사과의 핵심이에요.',
    passFeedback: '사고 설명이 또렷해요. 오해 줄어듦.',
    failFeedback: '“by mistake”가 빠지면 설명이 약해져요. 그 부분만!',
    difficulty: 'medium',
  },
  {
    id: 'conv-5',
    categoryId: 'convenience',
    sentence: 'My ramen got expensive.',
    korean: '제 라면이 비싸졌어요.',
    nativeTip: '가격 디스는 가볍게—진지하게 말하면 웃김이 줄어요.',
    passFeedback: '물가 감정이 살아 있어요. 공감 개그 성공.',
    failFeedback: '“expensive”가 뭉개졌어요. 마지막 단어만 집중!',
    difficulty: 'medium',
  },
  {
    id: 'class-1',
  ...
  },
  {
    id: 'class-3',
    categoryId: 'class',
    sentence: 'Can I submit it tonight?',
    korean: '오늘 밤 제출해도 될까요?',
    nativeTip: '“submit it tonight” 순서를 지키면 정중해요.',
    passFeedback: '기한 협상 멘트, 자연스러웠어요.',
    failFeedback: '“tonight”가 묻혔어요. 마지막 단어만 집중!',
    difficulty: 'medium',
  },
  {
    id: 'class-4',
    categoryId: 'class',
    sentence: 'The code attacked me.',
    korean: '코드가 절 공격했어요.',
    nativeTip: '과장은 짧게—“attacked me”만 살리면 웃겨요.',
    passFeedback: '개발자 밈 전달 OK.',
    failFeedback: '“attacked”가 흐릿했어요. 재미 포인트만 다시!',
    difficulty: 'medium',
  },
  {
    id: 'class-5',
  ...
  },
  {
    id: 'date-5',
    categoryId: 'date',
    sentence: 'That laugh was panic.',
    korean: '방금 웃음은 긴장이었어요.',
    nativeTip: '“panic” 한 방이면 설명 끝이에요.',
    passFeedback: '긴장 핑계가 귀여웠어요.',
    failFeedback: '“panic”이 흐릿했어요. 마지막 단어만 집중!',
    difficulty: 'medium',
  },
  {
    id: 'shop-1',
  ...
  },
  {
    id: 'shop-4',
    categoryId: 'shopping',
    sentence: 'My wallet said no.',
    korean: '지갑은 안 된대요.',
    nativeTip: '지갑한테 말 걸기—톤만 가볍게.',
    passFeedback: '유머가 과하지 않게 박혔어요.',
    failFeedback: '“wallet said no”가 묻혔어요. 그 구간만 다시!',
    difficulty: 'medium',
  },
  {
    id: 'shop-5',
